        ...
        <motion.div className="footer-top" variants={itemVariants}>
          <div className="footer-top-left">
            ...
            <div className="social-links">
              <motion.a href="https://www.linkedin.com/in/devang-singh-258476284" target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.2 }} className="social-icon">LinkedIn</motion.a>
              <motion.a href="https://github.com/devang9890" target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.2 }} className="social-icon">GitHub</motion.a>
              <motion.a href="https://x.com/" target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.2 }} className="social-icon">Twitter</motion.a>
            </div>
          </div>
